...
/* harmony export */ });
/* unused harmony exports Ad, AdCustom, Audio, Camera, Canvas, Checkbox, CheckboxGroup, CoverImage, CoverView, Editor, Form, FunctionalPageNavigator, KeyboardAccessory, Label, LivePlayer, LivePusher, Map, MatchMedia, MovableArea, MovableView, NativeSlot, NavigationBar, Navigator, OfficialAccount, OpenData, PageContainer, PageMeta, PickerView, PickerViewColumn, Progress, Radio, RadioGroup, RichText, RootPortal, ShareElement, Slider, Slot, Switch, Video, VoipRoom, WebView */
var View = 'view';
var Icon = 'icon';
